---
title: "Listing Connected Actions for a User in Composio"
sidebarTitle: "Listing Connected Actions for a User in Composio"
icon: "plug"
description: "In Composio, managing and monitoring your connections is essential for maintaining an organized and efficient workflow. This page will help you list and manage the connections associated with your account, allowing you to keep track of the active integrations and their details."
---
...
This command will display a comprehensive list of all connections, providing an overview of the various integrations linked to your account.
...
This command filters the list to show only the active connections, making it easier to identify which integrations are currently in use.
