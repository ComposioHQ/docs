...
sidebarTitle: "Python Code Execution"
icon: "code"
description: "This guide demonstrates how to execute Python code using Composio and Langchain."
---
...
<Steps>
    ...
    `cd cookbook/examples/interpreter_agent`
