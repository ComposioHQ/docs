---
title: "🐪 Using Composio With CamelAI"
sidebarTitle: "Camel SDK"
icon: "robot"
...
Ensure you have the necessary packages installed and connect your GitHub account to allow your CamelAI agents to utilize GitHub functionalities.
<CodeGroup>
    ``` bash Run command
