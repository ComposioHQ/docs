...
## Select Your App 🧑🏻‍💻
<select onChange={(e) => setApp(e.target.value)} value={app}>
  <option value="GitHub">GitHub</option>
  <option value="OtherApp">Other App</option>
</select>

{app === 'GitHub' ? 
  <>
   ## Try Composio with GitHub 🧑🏻‍💻 🕰️ 3 minutes
...
{app === 'OtherApp' ? 
<> 
## Try Composio with OtherApp 🧑🏻‍💻 🕰️ 3 minutes 
</>
}
```
